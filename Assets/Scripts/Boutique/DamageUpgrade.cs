...
public class DamageUpgrade : MonoBehaviour
{
    ...
    [Header("Achat")]
    [SerializeField] private int coutParAchat;
    [SerializeField] private int achatMax;
    ...
    void Start()
    {
        ...
        niveauActuel = PlayerPrefs.GetInt("DamageUpgradeLevel", 0); // Ce truc est basiquement un "cookie"
        UpdateUI();
    }
    ...
    public void AcheterHP()
    {
        ...
        // Ajouter un niveau
        niveauActuel++;
        PlayerPrefs.SetInt("DamageUpgradeLevel", niveauActuel);
        PlayerPrefs.Save();
