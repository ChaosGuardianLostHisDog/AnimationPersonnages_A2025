...
public class EnduranceUpgrade : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        niveauActuel = PlayerPrefs.GetInt("EnduranceUpgradeLevel", 0); // Ce truc est basiquement un "cookie"
        UpdateUI();
    }
    ...
    public void AcheterHP()
    {
        ...
        // Ajouter un niveau
        niveauActuel++;
        PlayerPrefs.SetInt("EnduranceUpgradeLevel", niveauActuel);
        PlayerPrefs.Save();
